## Contributing
♥ **1PlaceHolder** and want to get involved ?  
Thanks! There are plenty of ways you can help.  

### Report issues
Check project and report your issue [here](https://github.com/AliMD/1PlaceHolder/issues)    
...
2. Clone your fork (`git clone
   https://github.com/<your-username>/1PlaceHolder.git`).

3. Add an `upstream` remote (`git remote add upstream
   https://github.com/AliMD/1PlaceHolder.git`).
